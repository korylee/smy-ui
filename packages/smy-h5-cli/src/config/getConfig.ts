...
import { SITE_CONFIG, SITE_DIR, SITE_OUTPUT_DIR, SITE_OUTPUT_PATH, SITE_PUBLIC_PATH, SMY_CONFIG, VITE_RESOLVE_EXTENSION } from "../shared/constant";
...
export function getSmyConfig(): Record<string, any> {
  let config: any = {};
